...
export const COMPARISON_PAGES: ComparisonPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Matchning och offerter', content: '**Updro** – Du beskriver ditt projekt och får upp till tre offerter från matchade byråer inom 24 timmar. Byråerna kontaktar dig.\n\n**Hittabyrå** – Du bläddrar i en katalog, filtrerar på tjänster och plats, och kontaktar byråer själv. Ingen automatisk matchning eller offert-process.' },
