...
export const COMPARISON_PAGES: ComparisonPage[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Vad är skillnaden mot Offerta?', a: 'Updro är specialiserat på digitala uppdrag och verifierar byråernas företagsuppgifter. Offerta är bredare och täcker även fysiska tjänster som hantverk, men med mindre detaljerad kvalitetskontroll för digitala leverantörer.' },
      { q: 'Hur snabbt får jag offerter?', a: 'Byråer på Updro återkommer oftast inom 24 timmar med skräddarsydda offerter – det är en målsättning, inte en garanti. Du får upp till tre offerter.' },
