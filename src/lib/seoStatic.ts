...
const baseRoutes = (): StaticSeoRoute[] => [
  ...
  { path: '/priser', title: 'Priser för digitala byråer – pay per lead eller månadskort | Updro', description: 'Se Updros transparenta priser för byråer och prisnivåer för digitala tjänster innan du jämför offerter.', h1: 'Priser för byråer och digitala tjänster', priority: 0.8, changefreq: 'weekly', lastmod: today() },
