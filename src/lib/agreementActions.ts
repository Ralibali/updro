...
const contentSchema = z.object({
  version: z.literal(1), scope: z.string().min(3), special_terms: z.string(),
...
export async function updateProjectAgreement(offerId: string, action: 'create' | 'edit' | 'confirm', revision = 0, edits?: { scope: string; special_terms: string }) {
