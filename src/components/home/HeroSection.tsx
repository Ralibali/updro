      ...
      <div className="container relative z-10 py-20 md:py-28">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 text-left">
            <motion.h1
              className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight text-foreground leading-[1.05] [text-wrap:balance]"
          ...
          {/* Right: stack of mock offer cards */}
          <div className="hidden md:block md:col-span-5 relative h-[480px]">
            {mockOffers.map((offer, i) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0, rotate: offer.rotate }}
