...
import { Home, Search, FileText, MessageCircle, UserCircle, CreditCard, Check, Sparkles } from 'lucide-react'
      ...
      <div className="max-w-4xl">
        ...
        {isOnTrial && (
          <div className="bg-accent/10 border border-accent/20 rounded-xl p-5 mb-8">
            ...
            <p className="text-sm text-muted-foreground">{trialLeadsLeft} av {TRIAL_LEADS} gratis leads kvar · {trialDaysLeft} dagar kvar</p>
