...
import { Home, ClipboardList, MessageCircle, UserCircle, Plus, ArrowRight, Hand } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { CATEGORY_STYLES, BUDGET_LABELS } from '@/lib/constants'
import { timeAgo } from '@/lib/dateUtils'
import ProjectStepper, { calculateCurrentStep } from '@/components/shared/ProjectStepper'
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (proj) {
        ...
        // Fetch offers for each project (for stepper)
